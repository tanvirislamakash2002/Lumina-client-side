...
import { Search, FolderKanban, CheckSquare, Users, MessageSquare, Clock, ArrowRight } from "lucide-react";
...
export function ProjectActivitiesTab({ projectId, initialActivities }: ProjectActivitiesTabProps) {
        ...
        <Card>
            <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button variant="ghost" size="sm" asChild>
                    <Link href={`/dashboard/activities?projectId=${projectId}`}>
                        View all
