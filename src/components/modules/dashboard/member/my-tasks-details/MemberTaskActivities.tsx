...
import { Activity, CheckSquare, Users, MessageSquare, Clock, Paperclip } from "lucide-react";

interface MemberTaskActivitiesProps {
...
export function MemberTaskActivities({ initialActivities }: MemberTaskActivitiesProps) {
