...
interface MemberProfileTasksTabProps {
    userId: string;
    initialTasks: any[];
}
...
export function MemberProfileTasksTab({ userId, initialTasks }: MemberProfileTasksTabProps) {
                                    ...
                                    <TableRow key={task.id}>
                                        ...
                                        <TableCell>
                                            <Button variant="ghost" size="icon" asChild>
                                                <Link href={`/dashboard/my-tasks/${task.id}`}>
