...
interface MemberProfileActivitiesTabProps {
    activities: any[];
}
...
export function MemberProfileActivitiesTab({ activities }: MemberProfileActivitiesTabProps) {
                                    ...
                                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                                        ...
                                        {activity.project && (
                                            <>
                                                ...
                                                <Link
                                                    href={`/dashboard/my-projects/${activity.project.id}`}
                                        ...
                                        {activity.task && (
                                            <>
                                                <span className="text-xs text-muted-foreground">•</span>
                                                <Link
                                                    href={`/dashboard/my-tasks/${activity.task.id}`}
                                                    className="text-xs text-indigo-600 hover:underline"
                                                >
                                                    {activity.task.title}
                                                </Link>
