...
import { Calendar, Eye, Search, AlertCircle, Circle, PlayCircle, CheckCircle } from "lucide-react";
import { updateTaskStatus } from "@/actions/task.action";
import { toast } from "sonner";

interface MemberProjectTasksTabProps {
    projectId: string;
    initialTasks: any[];
    currentUser: any;
    onTaskUpdate: () => void;
...
export function MemberProjectTasksTab({
    ...
    // Get unique assignees for filter - FIXED
    const assignees = Array.from(
        new Map(
            initialTasks
                .filter(task => task.assignedTo) // Only include tasks with assignedTo
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {filteredTasks.map((task) => {
                                ...
                                const canUpdateStatus = task.assignedTo?.id === currentUser.id;
