    ...
    return (
        <Card>
            <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle>My Projects</CardTitle>
                <Link href="/dashboard/my-projects" className="text-sm text-indigo-600 hover:text-indigo-700 flex items-center gap-1">
                    View all
            ...
            <CardContent className="space-y-4">
                {activeProjects.map((project) => {
                    ...
                    return (
                        <Link key={project.id} href={`/dashboard/my-projects/${project.id}`} className="block group">
