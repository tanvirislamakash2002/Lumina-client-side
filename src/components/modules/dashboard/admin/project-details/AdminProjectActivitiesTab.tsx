...
interface AdminProjectActivitiesTabProps {
    projectId: string;
...
export function AdminProjectActivitiesTab({ projectId, initialActivities }: AdminProjectActivitiesTabProps) {
    ...
    const actionTypes = [...new Set(initialActivities.map((a) => a.action))];
                                    ...
                                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                                        ...
                                        {activity.task && (
                                            <>
                                                ...
                                                <Link
                                                    href={`/dashboard/admin/tasks/${activity.task.id}`}
