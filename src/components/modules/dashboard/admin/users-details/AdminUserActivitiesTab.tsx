...
interface AdminUserActivitiesTabProps {
    activities: any[];
}
...
export function AdminUserActivitiesTab({ activities }: AdminUserActivitiesTabProps) {
                                    ...
                                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                                        ...
                                        {activity.project && (
                                            <>
                                                ...
                                                <Link
                                                    href={`/dashboard/admin/projects/${activity.project.id}`}
