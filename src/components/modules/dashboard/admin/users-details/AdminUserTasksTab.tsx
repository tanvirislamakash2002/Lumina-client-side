...
interface AdminUserTasksTabProps {
    userId: string;
    initialTasks: any[];
    userName: string;
}
...
export function AdminUserTasksTab({ userId, initialTasks, userName }: AdminUserTasksTabProps) {
                                ...
                                return (
                                    <TableRow key={task.id}>
                                        ...
                                        <TableCell className="hidden sm:table-cell">
                                            <Link
                                                href={`/dashboard/admin/projects/${task.project?.id}`}
