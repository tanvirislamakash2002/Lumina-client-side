...
import { Eye, EyeOff, Loader2, Mail, Lock, User, Sparkles, Camera, X } from "lucide-react";
...
export function RegisterForm({ ...props }: React.ComponentProps<typeof Card>) {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // For now, just set preview without backend upload
      // You can implement backend upload later
    ...
    <Card className="border-0 shadow-none lg:shadow-lg w-full max-w-md mx-auto" {...props}>
      <CardHeader className="space-y-1">
        <div className="flex justify-center lg:justify-start mb-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 text-xs font-medium">
            <Sparkles className="w-3 h-3" />
            <span>Join Lumina</span>
          </div>
        </div>
      ...
      <CardContent>
        ...
        >
          ...
          <Alert className="bg-indigo-50 dark:bg-indigo-950/20 border-indigo-200 dark:border-indigo-800">
            ...
            <AlertDescription className="text-sm text-indigo-700 dark:text-indigo-300 mt-2">
              By joining Lumina, you'll be able to manage projects, track tasks, and collaborate with your team effectively.
            </AlertDescription>
          </Alert>
        </form>
      </CardContent>
