...
export function LoginForm({ ...props }: React.ComponentProps<typeof Card>) {
  ...
  const handleDemoLogin = async (role: "admin" | "projectManager" | "teamMember") => {
    const credentials = DEMO_CREDENTIALS[role];
    setIsDemoLoading(role);
    setError(null);
    const toastId = toast.loading(`Logging in as ${role === "admin" ? "ADMIN" : role === "projectManager" ? "PROJECT MANAGER" : "TEAM MEMBER"}...`);
